static const char col_matrixgreen[] = "#00FF00"; /* Matrix green color */
...
static char *colors[][ColCount] = {
	...
	[SchemeSel]          = { selfgcolor,       selbgcolor,       col_matrixgreen,       selfloatcolor },
...
static const char *display1cmd[]  = { "/bin/bash", "/home/angelo/.config/display-profiles/1.sh" };
static const char *display2cmd[]  = { "/bin/bash", "/home/angelo/.config/display-profiles/2-inverted.sh" };
...
//{ MODKEY|Mod4Mask,              XK_space,      unfloatvisible,         {0} },
	...
	{ MODKEY|Mod1Mask,							XK_1,      	spawn,          {.v = display1cmd } },
	{ MODKEY|Mod1Mask,							XK_2,      	spawn,          {.v = display2cmd } },
	{ MODKEY,                       XK_space,  	togglelayout,      {1} },
	{ MODKEY|ShiftMask,             XK_space,  	togglefloating, {0} },
	{ MODKEY|ShiftMask|ControlMask|Mod1Mask,                       XK_1,          setlayout,              {.v = &layouts[0]} },
	{ MODKEY|ShiftMask|ControlMask|Mod1Mask,                       XK_2,          setlayout,              {.v = &layouts[1]} },
	{ MODKEY|ShiftMask|ControlMask|Mod1Mask,                       XK_3,          setlayout,              {.v = &layouts[2]} },
	{ MODKEY|ShiftMask|ControlMask|Mod1Mask,                       XK_4,          setlayout,              {.v = &layouts[3]} },
	{ MODKEY|ShiftMask|ControlMask|Mod1Mask,                       XK_5,          setlayout,              {.v = &layouts[4]} },
//	{ MODKEY,                       XK_f,          setlayout,              {.v = &layouts[1]} },
//	{ MODKEY,                       XK_m,          setlayout,              {.v = &layouts[2]} },
	TAGKEYS(                        XK_1,                                  0)
	TAGKEYS(                        XK_2,                                  1)
...
static const Command commands[] = {
	...
	{ {ControlMask, 0,          0,         0},    {XK_w,      XK_v,     0,         0},            setlayout,       {.v = &//ayouts[0]} },
